package com.zeta.zetamod.features.dimensions.generators;
...
public class LushNetherChunkGenerator extends ChunkGenerator {
    // Just an example of adding a custom boolean
    protected final boolean customBool;

    public static final Codec<LushNetherChunkGenerator> CODEC = RecordCodecBuilder.create((instance) ->
            instance.group(
                    ...
                    .apply(instance, instance.stable(LushNetherChunkGenerator::new))
    );

    public LushNetherChunkGenerator(BiomeSource biomeSource, boolean customBool) {
