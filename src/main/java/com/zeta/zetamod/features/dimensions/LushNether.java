...
import com.zeta.zetamod.features.dimensions.generators.LushNetherChunkGenerator;
...
public class LushNether implements ModInitializer {
    ...
    private static final RegistryKey<DimensionOptions> DIMENSION_KEY = RegistryKey.of(
            ...
            new Identifier(ZMMain.MOD_ID, "lush_nether")
    );
    ...
    private static final RegistryKey<DimensionType> DIMENSION_TYPE_KEY = RegistryKey.of(
            ...
            new Identifier(ZMMain.MOD_ID, "lush_nether_type")
    );
    public static final String modid = ZMMain.MOD_ID;
    @Override
    public void onInitialize() {
        Registry.register(Registry.CHUNK_GENERATOR, new Identifier(modid, "lush_nether"), LushNetherChunkGenerator.CODEC);

        WORLD_KEY = RegistryKey.of(Registry.WORLD_KEY, new Identifier(modid, "lush_nether"));
        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, dedicated) ->
                dispatcher.register(literal("lush_nether").executes(LushNether.this::swapTargeted))
        );
    }
