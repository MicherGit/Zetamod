...
public class ConcerningBiome {
    ...
    public static void register() {
        ...
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "gigaconcern_block"), new BlockItem(GIGACONCERN_BLOCK, new Item.Settings().group(ZetaForged.ZETAMOD_ITEMS)));
