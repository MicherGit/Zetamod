package code.zeta.zetamod.util.hash;

import code.zeta.zetamod.mod.managers.ConfigManager;
...
public class TrinaryHash {
    ...
    private static List<String> hashList = new ArrayList<>(Arrays.asList(genRandomHash()));
