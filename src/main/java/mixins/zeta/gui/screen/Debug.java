                ...
                list = Lists.newArrayList(
                        new String[]{
                                "Minecraft "
                                        ...
                                        " (" + this.client.getGameVersion() + "/"+CodenameEliXrMain.MOD_NAME+" " + CodenameEliXrMain.PHASE
