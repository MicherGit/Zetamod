                ...
                list = Lists.newArrayList(
                        new String[]{
                                "Minecraft "
                                        ...
                                        " (" + this.client.getGameVersion() + "/zet2mod " + CodenameEliXrMain.PHASE
